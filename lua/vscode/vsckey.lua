...
--------------debuging------------------
vskcmd("<leader>dd", "workbench.action.debug.start", opts)
vskcmd("<leader>dD", "workbench.action.debug.stop", opts)
vskcmd("<leader>dg", "workbench.action.debug.continue", opts)
...
vskcmd("<leader>dv", "debug.setVariable", opts)
vskcmd("<leader>dc", "workbench.debug.viewlet.action.removeAllBreakpoints", opts)
...
vskcmd("<leader>dh", "editor.debug.action.showDebugHover", opts)
--Externsion----------------------------------
